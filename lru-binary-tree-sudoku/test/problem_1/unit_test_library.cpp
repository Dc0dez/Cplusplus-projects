...
TEST(problem_1, library) {
    ...
    /*
     * I got help from Peng narrowing down the logic error in this test
     * Task 1.3:
     * The logic error in this code is that Frankenstein was borrowed again but not returned
     * This causes the test to fail when library.borrow_book is called on Frankenstein again on line 74 since it does not exist
     * To resolve this issue, I added a line of code returning Frankenstein to the shelf on line 61
     */
